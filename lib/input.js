  ...
  constructor() {
    ...
    if (minimist) {
      ...
      if (this.checking(minimist.a || minimist.add)) {
        ...
        return { errors: 'ERROR: You should add a text OR the flag should be ((-a,--add "text" --category "the category")=> for adding text) (--delete "the Id"(for deleting)) (--list "the category"==output>>(listing the data))' };
      }
    }
